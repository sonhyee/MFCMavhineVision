...
BEGIN_MESSAGE_MAP(CMFCMachineVisionDlg, CDialogEx)
	...
	ON_MESSAGE(UM_INSPEND, TimeCheck)  // InspectionHandler에서 그랩 후 이미지 로드
...
UINT CMFCMachineVisionDlg::ThreadFunc(LPVOID lParam)
{
	CMFCMachineVisionDlg* pDlg = (CMFCMachineVisionDlg*)lParam;

	pDlg->m_InspectionHandler.StartInspection();
